...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template name="hyperlink">
        ...
        <!--         1 initial comma or ;/ 2 space/ 3 book name or abbrevation (optional . removed latter)/  4 space /  5 chapter or verse number / 6 punctuation / 7 verse number/ 8 abff / 9 verse number / 10 abff /                                                                                                                  -->
