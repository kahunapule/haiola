...
\newcommand{\GRC}{\renewcommand{\TempFace}{Gentium Plus}\SetFace}
\newcommand{\HEB}{\renewcommand{\TempFace}{Ezra SIL}\SetFace}
\newcommand{\ARB}{\renewcommand{\TempFace}{Amiri}\SetFace}
...
\setTransitionsFor{Hebrew}{\HEB}{\SetFont}
\setTransitionsFor{Greek}{\GRC}{\SetFont}
\setTransitionsFor{Arabic}{\ARB}{\SetFont}
\setTransitionsFor{Latin}{\renewcommand{\TempFace}{Noto Serif}\SetFace}{\SetFont}
\setTransitionsFor{Thai}{\renewcommand{\TempFace}{Noto Serif Thai}\SetFace}{\SetFont}
\setTransitionsFor{Chinese}{\renewcommand{\TempFace}{Noto Serif CJK HK}\SetFont}{\SetFont}
