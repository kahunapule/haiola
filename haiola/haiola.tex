...
\setTransitionTo{GeneralPunctuation}{\renewcommand{\ThisFont}{Noto Serif}\SetFont}
...
\setTransitionsFor{LetterlikeSymbols}{\renewcommand{\ThisFont}{Noto Sans Math}\SetFont}{\NormalFace}
