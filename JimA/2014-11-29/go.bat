...
:validate
echo ------------------------------------------------
echo . step 7 - validate sample
echo ------------------------------------------------
echo . output: %2\convert\sampleRefs.validate.usx
echo . input:  %2\convert\sampleRefs.usx
echo . xsl:    XSLT\validate.xsl

call "C:\Program Files\Saxonica\SaxonHE9.4N\bin\transform" -o:%2\convert\sampleRefs.validate.usx %2\convert\%1.step6.xml XSLT\validate.xsl
