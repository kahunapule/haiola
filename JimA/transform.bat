...
"C:\Program Files\Saxonica\SaxonHE9.4N\bin\transform" -o:%2\convert\%1.step3.xml c:\d\Kahuna\%2\source\%1 XSLT\step3.xsl pathToFiles="C:\d\kahuna\"
goto end3
:usx3
...
call "C:\Program Files\Saxonica\SaxonHE9.4N\bin\transform" -o:%2\convert\sampleRefs.validate.usx %2\convert\%1.step5.xml XSLT\validate.xsl
