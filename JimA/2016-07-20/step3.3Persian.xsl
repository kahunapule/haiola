  ...
  <reading value="{key('k', @code, 
   document('lookup.xml'))}"/> 
    ...
    <xsl:template name="hyperlink">
        ...
        -->
        <!--       regex="([&rlm;&lrm;]*[,;&arabicSemicolon;&arabicComma;&arabicAnd;])*(\s)?([&rlm;&lrm;]*{$allowedBooksAbbreviationShortLong})?(\.)?([&rlm;&lrm;]*[&nbsp;\s])?[&rlm;&lrm;]*([0-9]+)([&rlm;&lrm;]*[\.:,&arabicColon;&arabicComma;&mdash;&nbsp;-])?[&rlm;&lrm;]*([0-9]+)?([a-z]*)([&rlm;&lrm;]*[\.:&arabicColon;&mdash;&nbsp;-])?[&rlm;&lrm;]*([0-9]+)?([a-z]*)?([&rlm;&lrm;]*[\.:&arabicColon;&mdash;&nbsp;-])?[&rlm;&lrm;]*([0-9]+)?([a-z]*)((\sو)(\s[0-9]))?">
       -->
        <xsl:analyze-string select="$string"
regex="([&rlm;&lrm;]*[,;&arabicSemicolon;&arabicComma;&arabicAnd;])*(\s)?([&rlm;&lrm;]*{$allowedBooksAbbreviationShortLong})?(\.)?([&rlm;&lrm;]*[&nbsp;\s])?[&rlm;&lrm;]*([0-9]+)([&rlm;&lrm;]*[\.:,&arabicColon;&arabicComma;&mdash;&nbsp;-])[&rlm;&lrm;]*([0-9]+)?([a-z]*)([&rlm;&lrm;]*[\.:&arabicColon;&mdash;&nbsp;-])?[&rlm;&lrm;]*([0-9]+)?([a-z]*)?([&rlm;&lrm;]*[\.:&arabicColon;&mdash;&nbsp;-])?[&rlm;&lrm;]*([0-9]+)?([a-z]*)">
